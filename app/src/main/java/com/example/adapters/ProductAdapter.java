...
class ProductAdapter extends ArrayAdapter<Cars> {
    private LayoutInflater inflater;
    private int layout;
    private ArrayList<Cars> productList;

    ProductAdapter(Context context, int resource, ArrayList<Cars> products) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Cars product = productList.get(position);
